...
[alisw]
name=ALICE Software - EL10
baseurl=https://s3.cern.ch/swift/v1/alibuild-repo/RPMS/el10.$(uname -m)/
enabled=0
gpgcheck=0
EOF
...
[alisw-upd]
name=ALICE Software - EL10
baseurl=https://s3.cern.ch/swift/v1/alibuild-repo/UpdRPMS/el10.$(uname -m)/
enabled=0
gpgcheck=0
EOF
...
%changelog
* Tue Mar 31 2026 Timo Wilken <timo.wilken@cern.ch> 1-1
- Initial package
